...
class Adapter_favorite (val listener: Listener, private val myContext: Context): RecyclerView.Adapter<Adapter_favorite.Holder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): Adapter_favorite.Holder {
    ...
    override fun onBindViewHolder(holder: Adapter_favorite.Holder, position: Int) {
